export const DEMOS = [
  ...
  {
    id: 'intelligent-form-processing',
    title: 'Intelligent Form Processing',
    description:
      'Upload any form image or PDF. Donut DocVQA extracts fields automatically, low-confidence results route to a human review queue, a DMN table triages the request, and calculations are stored end-to-end in FluxNova.',
    tags: ['AI', 'OCR', 'BPM', 'Finance'],
    status: 'live',
    route: '/hub/demos/intelligent-form-processing',
    thumbnail: null,
    highlights: [
      'Donut DocVQA field extraction (CPU-only, no API key)',
      'Per-field confidence scoring with automatic human-review routing',
      'DMN triage table: loan / refund / account / manual-triage',
      'Three external task workers: extraction → calculation → store',
      'Straight-through vs. reviewed path both tracked in results',
    ],
    techStack: ['FluxNova', 'Donut (Hugging Face)', 'Python FastAPI', 'React 19', 'Node.js / Express 5', 'DMN', 'multer'],
    flowSteps: [
      { label: 'Upload\nForm', icon: '📄' },
      { label: 'AI\nExtract', icon: '🤖' },
      { label: 'Human\nReview?', icon: '👤' },
